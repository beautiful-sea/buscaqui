<?php if(!class_exists('Rain\Tpl')){exit;}?>      <div class="intro-full ms-hero-img-black_wall ms-hero-bg-primary color-white " id="home">
          ...
          <div class="container" style="height: 100%">
            <div class="text-center mb-4">
              ...
              <p class="lead lead-lg color-white text-center center-block mt-2 mw-800 text-uppercase fw-300 animated lightSpeedIn animation-delay-7"><span class="ms-logo ms-logo-white ms-logo-sm"><i class="fa fa-search"></i></span> Encontre
                ...
                <span class="animated lightSpeedIn animation-delay-14">na</span>
                <span class="animated lightSpeedIn animation-delay-20">sua</span>
                <span class="animated lightSpeedIn animation-delay-26">cidade</span>
              </p>
