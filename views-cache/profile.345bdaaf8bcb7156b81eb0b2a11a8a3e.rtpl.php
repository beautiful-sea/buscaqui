              ...
              <div class="col-lg-12 col-md-6 order-md-1">
                <div class="card animated fadeInUp animation-delay-7">
                  <div class="ms-hero-bg-primary ms-hero-img-coffee">
                    ...
                    <img src="res/site/img/demo/avatar1.jpg" alt="..." class="img-avatar-circle"> </div>
                  ...
                  <div class="card-body">
                    <div class="ms-media-list">
                      <div class="media mb-2">
                        <a class="mr-3" href="#">
                          <img class="media-object" src="res/site/img/demo/avatar6.jpg"> </a>
                      ...
                      <div class="media mb-2">
                        <div class="media-left media-middle">
                          <a class="mr-3" href="#">
                            <img class="media-object" src="res/site/img/demo/avatar3.jpg"> </a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media mb-2">
                        <div class="media-left media-middle">
                          <a class="mr-3" href="#">
                            <img class="media-object" src="res/site/img/demo/avatar5.jpg"> </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active show" id="home">
                      <table class="table table-no-border table-striped">
                        <tr>
                          <th>
                            <i class="zmdi zmdi-account mr-1 color-success"></i> User Name
                          </th>
                          <td>vic_smith</td>
                        </tr>
                        <tr>
                ...
                <ul class="ms-timeline">
                  <li class="ms-timeline-item wow materialUp">
                    <div class="ms-timeline-date">
                      ...
                      <img src="res/site/img/demo/avatar6.jpg" class="ms-timeline-point-img"> </div>
                    <div class="card card-royal">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-sm-4">
                            <img src="res/site/img/demo/office1.jpg" alt="" class="img-fluid"> </div>
                          <div class="col-sm-8">
                  ...
                  <li class="ms-timeline-item wow materialUp">
                    <div class="ms-timeline-date">
                      ...
                      <img src="res/site/img/demo/avatar2.jpg" class="ms-timeline-point-img"> </div>
                    <div class="card card-warning">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <img src="res/site/img/demo/office2.jpg" alt="" class="img-fluid"> </div>
                          <div class="col-sm-4">
                            <img src="res/site/img/demo/office3.jpg" alt="" class="img-fluid"> </div>
                          <div class="col-sm-4">
                            <img src="res/site/img/demo/office4.jpg" alt="" class="img-fluid"> </div>
                        </div>
                        <br>
                  ...
                  <li class="ms-timeline-item wow materialUp">
                    <div class="ms-timeline-date">
                      ...
                      <i class="ms-timeline-point bg-info"></i>
                      <img src="res/site/img/demo/avatar3.jpg" class="ms-timeline-point-img"> </div>
                    <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Card Title</h3>
                      </div>
