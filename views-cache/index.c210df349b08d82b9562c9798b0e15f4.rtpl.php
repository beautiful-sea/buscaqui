<?php if(!class_exists('Rain\Tpl')){exit;}?>      <div class="modal modal-warning" id="myModal" tabindex="-1" role="dialog" aria-labelledby="successlottery">
          <div class="modal-dialog animated zoomIn animated-3x" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h3 class="modal-title color-primary" id="successlottery">Modal title</h3>
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-5">
              <div class="ms-hero-img animated zoomInUp animation-delay-30">
                <img src="res/site/img/demo/mock-imac-material2.png" alt="" class="img-fluid">
                <div id="carousel-hero-img" class="carousel carousel-fade slide" data-ride="carousel" data-interval="3000">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="ms-hero-img-slider carousel-item active">
                      <img src="res/site/img/demo/hero1.png" alt="" class="img-fluid"> </div>
                    <div class="ms-hero-img-slider carousel-item">
                      <img src="res/site/img/demo/hero3.png" alt="" class="img-fluid"> </div>
                    <div class="ms-hero-img-slider carousel-item">
                      <img src="res/site/img/demo/hero2.png" alt="" class="img-fluid"> </div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- ms-hero ms-hero-black -->
        <div class="container" id="intro-next">
          <h2 class="text-center color-primary mb-2 wow fadeInDown animation-delay-4">Itens mais populares!</h2>
          <p class="lead text-center aco wow fadeInDown animation-delay-5 mw-800 center-block mb-4"> Conheça nossas
            <span class="color-info">categorias</span> mais pesquisadas !</p>
          <div class="row">
            <div class="col-lg-3 col-sm-6">
              <div class="card card-info animated zoomInUp animation-delay-5">
                <div class="bg-info">
                  <img src="res/site/img/demo/lanchonete.jpg" alt="..." class="img-avatar-circle"> </div>
                <div class="card-body pt-4 text-center">
                  <h4 class="color-info">Lanchonete</h4>
                  <p>Que tal pesquisar números de lanchonetes e pedir logo um x-tudo!?</p>
                  <a href="javascript:void(0)" class="btn btn-info">
                    <i class="zmdi zmdi-star"></i> Ver Mais</a>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="card card-danger animated zoomInUp animation-delay-6">
                <div class="bg-danger">
                  <img src="res/site/img/demo/pizzaria.jpg" alt="..." class="img-avatar-circle"> </div>
                <div class="card-body pt-4 text-center">
                  <h4 class="color-danger">Pizzaria</h4>
                  <p>Se você pensa que pode conquistar alguém com pizza, você está certo!</p>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card card-warning animated zoomInUp animation-delay-7">
                <div class="bg-warning">
                  <img src="res/site/img/demo/artesanato.png" alt="..." class="img-avatar-circle"> </div>
                <div class="card-body pt-4 text-center">
                  <h4 class="color-warning">Artesanato</h4>
                  <p>ARTESANATO: Inspiração, Transpiração e Amor. Todos nós amamos!</p>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card card-success animated zoomInUp animation-delay-8">
                <div class="bg-success">
                  <img src="res/site/img/demo/tatuador.png" alt="..." class="img-avatar-circle"> </div>
                <div class="card-body pt-4 text-center">
                  <h4 class="color-success">Tatuador</h4>
                  <p>Você sabia? Fazer tatuagem é mostrar na pele o que se esconde na alma!</p>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6 order-lg-2 mb-4  center-block">
              <img src="res/site/img/demo/mock.png" alt="" class="img-fluid center-block wow zoomIn animation-delay-12 "> </div>
          ...
          <div class="panel-body">
            ...
            <div class="tab-content mt-4">
              <div role="tabpanel" class="tab-pane fade" id="windows">
                <div class="row">
                  <div class="col-lg-6 order-lg-2">
                    <img src="res/site/img/demo/mock4.png" alt="" class="img-fluid animated zoomIn animation-delay-8"> </div>
              ...
              <div role="tabpanel" class="tab-pane active show fade" id="macos">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="res/site/img/demo/mock2.png" alt="" class="img-fluid wow animated zoomIn animation-delay-8"> </div>
                  <div class="col-lg-6">
              ...
              <div role="tabpanel" class="tab-pane fade" id="linux">
                <div class="row">
                  <div class="col-lg-6 order-lg-2">
                    <img src="res/site/img/demo/mock5.png" alt="" class="img-fluid animated zoomIn animation-delay-8"> </div>
                  <div class="col-lg-6 order-lg-1">
                    <h3 class="text-normal animated fadeInUp animation-delay-4">Bring ideas together faster</h3>
                    <p class="lead lead-md animated fadeInUp animation-delay-6">Create documents, spreadsheets and presentations from anywhere. Share them with teammates and work together on the same file, at the same time.</p>
                    <p class="lead lead-md animated fadeInUp animation-delay-7">sing your work is easy with one login for everything you do. Administrative controls offer two-step verification to enhance security for the whole company.</p>
              ...
              <div role="tabpanel" class="tab-pane fade" id="android">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="res/site/img/demo/mock6.png" alt="" class="img-fluid animated zoomIn animation-delay-8"> </div>
                  <div class="col-lg-6">
                    <h3 class="text-normal animated fadeInUp animation-delay-4">Bring ideas together faster</h3>
                    <p class="lead lead-md  animated fadeInUp animation-delay-6">Create documents, spreadsheets and presentations from anywhere. Share them with teammates and work together on the same file, at the same time.</p>
                    <p class="lead lead-md animated fadeInUp animation-delay-7">sing your work is easy with one login for everything you do. Administrative controls offer two-step verification to enhance security for the whole company.</p>
              ...
              <div role="tabpanel" class="tab-pane fade" id="ios">
                <div class="row">
                  <div class="col-lg-6 order-lg-2">
                    <img src="res/site/img/demo/mock3.png" alt="" class="img-fluid animated zoomIn animation-delay-8"> </div>
                  <div class="col-lg-6 order-lg-1">
                    <h3 class="text-normal animated fadeInUp animation-delay-4">Bring ideas together faster</h3>
                    <p class="lead lead-md animated fadeInUp animation-delay-6">Create documents, spreadsheets and presentations from anywhere. Share them with teammates and work together on the same file, at the same time.</p>
                    <p class="lead lead-md animated fadeInUp animation-delay-7">sing your work is easy with one login for everything you do. Administrative controls offer two-step verification to enhance security for the whole company.</p>
      ...
      <div class="container mt-6">
        <div class="text-center mb-4">
          <h2 class="uppercase color-primary">Conheça nossos planos</h2>
          <p class="lead uppercase">Surpreenda-se com nossos recursos exclusivos</p>
        </div>
      <div class="container">
          ...
          <div class="col-md-4 d-none d-lg-block pricing-col">
            <div class="pricing-table pricing-table-description">
              <div class="pricing-table-head">
                <h2> Planos Disponíveis
                  <span></span>
                </h2>
                <h3 class="price"> Serviços </h3>
              </div>
          ...
          <div class="col-lg-2 col-md-6 pricing-col">
            <div class="pricing-table">
              <div class="pricing-table-head">
                ...
                <h3 class="price"> R$
                  <i>14</i>.99
                  <span class="d-inline d-lg-none">Per Month</span>
                </h3>
              </div>
              <ul class="pricing-table-content">
                <li> 1
                  <span class="d-block d-lg-none">Domains</span>
                </li>
                <li> 10
                  <span class="d-block d-lg-none">Subdomains</span>
                </li>
                <li> 10 GB
                  <span class="d-block d-lg-none">Diskspace</span>
                </li>
                <li>
                  <i class="fa fa-times"></i>
                  <span class="d-block d-lg-none">Email Addresses</span>
                </li>
                <li> 1
                  <span class="d-block d-lg-none"> MySQL Databases</span>
                </li>
                <li> R$50
                  <span class="d-block d-lg-none">Google AdWords Credits</span>
                </li>
                <li>
                  <i class="fa fa-check"></i>
                  <span class="d-block d-lg-none">SSH Access</span>
                </li>
                <li>
                  <i class="fa fa-check"></i>
                  <span class="d-block d-lg-none">Message from Users List</span>
                </li>
                <li>
                  <i class="fa fa-check"></i>
                  <span class="d-block d-lg-none">PHP 5, Python, Node.js</span>
                </li>
                <li>
                  <i class="fa fa-times"></i>
                  <span class="d-block d-lg-none">Scheduled Lock Screen</span>
                </li>
                <li>
                  <i class="fa fa-times"></i>
                  <span class="d-block d-lg-none">Ports Controls</span>
                </li>
                <li>
                  <i class="fa fa-times"> </i>
                  <span class="d-block d-lg-none">Customizable Templates</span>
                </li>
                <li>
                  <i class="fa fa-times"></i>
                  <span class="d-block d-lg-none">SSL Certificate</span>
                </li>
                <li>
                  <i class="fa fa-times"></i>
                  <span class="d-block d-lg-none">Premium DNS</span>
                </li>
                <li>
                  <i class="fa fa-check"></i>
                  <span class="d-block d-lg-none">Phone &amp; Support</span>
                </li>
              </ul>
              <div class="pricing-table-footer text-center">
                <a href="javascript:void(0)" class="btn btn-primary btn-raised">
                  <i class="zmdi zmdi-cloud-download"></i> Obter Agora</a>
              </div>
            </div>
          </div>
          <div class="col-lg-2 col-md-6 pricing-col">
                    ...
                    <div class="col-lg-4">
                      <div class="card animated flipInX animation-delay-2 mb-4">
                        <blockquote class="blockquote blockquote-avatar withripple">
                          <img src="res/site/img/demo/avatar.png" alt="" class="avatar d-none d-sm-block">
                  ...
                  <div class="media">
                    <div class="media-left media-middle">
                      <a href="javascript:void(0)">
                        <img class="media-object media-object-circle" src="res/site/img/demo/p75.jpg" alt="..."> </a>
                    </div>
