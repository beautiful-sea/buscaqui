        ...
        <div class="row">
              ...
              <div class="card-body no-pb">
                <form class="form-horizontal">
                  ...
                  <div class="form-group mt-1">
                    ...
                    <div class="radio no-mb">
                      <label>
                        <input type="radio" name="optionsRadios" id="optionsRadios<?php echo htmlspecialchars( $value1["idsubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" value="option<?php echo htmlspecialchars( $value1["idsubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="filter" data-filter=".category-<?php echo htmlspecialchars( $value1["idsubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"> <?php echo htmlspecialchars( $value1["dessubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </label>
                    </div>
                    <?php } ?>
          ...
          <div class="col-lg-9">
            <div class="row" id="Container">
              ...
              <div class="col-lg-4 col-md-6 mix category-<?php echo htmlspecialchars( $value1["idsubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                <div class="card">
                  <a href="/categories/">
                  <figure class="ms-thumbnail">
                    <img src="res/site/img/business/perfil/<?php echo htmlspecialchars( $value1["idbusiness"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.jpg" alt="" class="img-fluid">
                    <figcaption class="ms-thumbnail-caption text-center">
                      <div class="ms-thumbnail-caption-content">
                        <h4 class="ms-thumbnail-caption-title mb-2"><?php echo htmlspecialchars( $value1["desbusiness"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                      </div>
                    </figcaption>
                  </figure>
                  <div class="card-body overflow-hidden text-center portfolio-item-caption d-none">
                    <h3 class="color-primary no-mt"><?php echo htmlspecialchars( $value1["desbusiness"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                  </div>
                </a>
                </div>
              </div>
